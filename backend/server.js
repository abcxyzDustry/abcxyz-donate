...
const pool = new Pool({
  connectionString: 'postgresql://abcxyz_db_user:FCmImoRGpfpXhZ5MCwxUw0X9QQAUC61s@dpg-d4ejq5idbo4c73di9asg-a/abcxyz_db',
...
app.get('/api/env-check', (req, res) => {
  res.json({
    ...
    databaseMode: 'PostgreSQL (Persistent)',
